...
#ifndef POLYSTAR_MSGS__MSG__DETAIL__GAME_STATUS__FUNCTIONS_H_
#define POLYSTAR_MSGS__MSG__DETAIL__GAME_STATUS__FUNCTIONS_H_
 ...
 * calls
 * polystar_msgs__msg__GameStatus__init().
...
/**
 * It calls
 * polystar_msgs__msg__GameStatus__fini()
 ...
 * polystar_msgs__msg__GameStatus__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * polystar_msgs__msg__GameStatus__Sequence__fini()
 * on the array,
...
#endif  // POLYSTAR_MSGS__MSG__DETAIL__GAME_STATUS__FUNCTIONS_H_
